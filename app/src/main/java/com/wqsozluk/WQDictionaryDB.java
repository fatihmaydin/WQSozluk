...
public class WQDictionaryDB {
	 ...
	 */
	public WQDictionaryDB(Context context) {

			mWQDictionaryDBOpenHelper = new WQDictionaryDBOpenHelper(context);
	}
	...
	public Cursor getWordMatches(String selection, String query, String[] columns) {
		...
		if (columntoSearch.equalsIgnoreCase(KEY_DEFINITION)) 
		{
			...
			if (WQDictionaryActivity.typeToSearch.equalsIgnoreCase("hemû")) 
			{
				String query1=WQDictionaryActivity.zimanquery
			...
			{
				if(WQDictionaryActivity.typeToSearch.contains( "Ⓓ"))
				{
		...
		//	Log.d("WQDictionaryActivity.zimanquery", WQDictionaryActivity.zimanquery);
			//Log.d("query", query);
			...
			return new CurSorWrapperDefinition(cursor,
					WQDictionaryActivity.zimanquery
						,
					WQDictionaryActivity.letterx);			
	...
	private Cursor query(String selection, String[] selectionArgs,
		...
		Cursor cursor = builder.query(
				mWQDictionaryDBOpenHelper.getReadableDatabase(), columns,
	 ...
	 */
	public static class WQDictionaryDBOpenHelper extends SQLiteOpenHelper {
		...
		WQDictionaryDBOpenHelper(Context context) {
			super(context, DATABASE_NAME, null, DATABASE_VERSION);
			mHelperContext = context;
		}

		public WQDictionaryDBOpenHelper(Context context,
		...
		public Words GetSingleWord(String id)
		{
			...
			{
				String	id2 = GetValue(c, WQDictionaryDB.KEY_ID);			
				String def = GetValue(c, WQDictionaryDB.KEY_DEFINITION);
...
w.NormalizedWord=idd1;
		...
		public Words GetFavWord(String word)
		{
			...
			if(c!=null&&c.moveToFirst())
			{
				String	id2 = GetValue(c, WQDictionaryDB.KEY_WORD);
				ww=new Words();
				ww.peyv=id2;
			}			
			return ww;
		...
		public ArrayList< Words> GetFavWords()
		{
			try {
				...
				//Cursor defTable =	WQDictionaryDB.mWQDictionaryDBOpenHelper.GetSingleWord(id);
