...
public class WQFerhengDBProvider extends ContentProvider {
    String TAG = "WQFerhengDBProvider";

    public static String AUTHORITY = "com.wqferheng.WQFerhengDBProvider";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/wqferheng");
    ...
    private WQFerhengDB mDictionary;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "wqferheng", SEARCH_WORDS);
        matcher.addURI(AUTHORITY, "wqferheng/#", GET_WORD);
        // to get suggestions...
    ...
    public boolean onCreate() {
        mDictionary = new WQFerhengDB(getContext());
    ...
    private Cursor search(String selection, String query) {
     // query = query;
      String[] columns = new String[] {
          BaseColumns._ID,
          WQFerhengDB.KEY_WORD,
          WQFerhengDB.KEY_DEFINITION,   WQFerhengDB.KEY_WORD_N
          ,   WQFerhengDB.KEY_ID};
